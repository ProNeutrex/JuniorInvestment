                    ...
                    <ul class="dropdown-items">
                        @canany(['kyc-list', 'kyc-action'])
                            ...
                            <li class="{{ isActive('admin.kyc.all') }}">
                                <a href="{{ route('admin.kyc.all') }}"><i icon-name="contact"></i>{{ __('All KYC Logs') }}</a>
                            </li>
                        @endcanany
                        @can('kyc-form-manage')
            ...
            @canany(['automatic-gateway-manage', 'manual-gateway-manage', 'deposit-list', 'deposit-action',
                ...
                @canany(['automatic-gateway-manage', 'manual-gateway-manage', 'deposit-list', 'deposit-action'])
                    ...
                    <li class="side-nav-item side-nav-dropdown {{ isActive(['admin.deposit*']) }}">
                        <a href="javascript:void(0);" class="dropdown-link"><i
                                icon-name="arrow-down-circle"></i><span>{{ __('Deposits') }}</span><span class="right-arrow"><i
                    ...
                    <li class="side-nav-item side-nav-dropdown  {{ isActive(['admin.page.section.section*']) }}">
                        <a href="javascript:void(0);" class="dropdown-link"><i
                                icon-name="home"></i><span>{{ __('Landing Page') }}</span><span class="right-arrow"><i
                                    icon-name="chevron-down"></i></span></a>
                                    @php
        // Use dd() para imprimir os dados e encerrar a execução
        /*
        dd($landingSections);
        */
    @endphp
                        <ul class="dropdown-items">
                            @foreach ($landingSections as $section)
                                ...
                                @if (
                                    ...
                                    $sectionName == 'Schema Section' ||
                                    $sectionName == 'How it works Section' ||
                                    $sectionName == 'Recent Section' ||
                                    ...
                                    <li class="@if (request()->is('admin/page/section/' . $section->code)) active @endif">
                                        <a href="{{ route('admin.page.section.section', $section->code) }}">
                                            ...
                                            @if ($sectionName == 'Hero Section')
                                                Vídeo e introdução
                                            @endif
                                            @if ($sectionName == 'Schema Section')
                                                Planos
                                            @endif
                                            @if ($sectionName == 'How it works Section')
                                                Como funciona
                                            @endif                                    
                                            @if ($sectionName == 'Recent Section')
                                                Pagamentos e depósitos
                                            @endif
                                            @if ($sectionName == 'Blog Section')
                                                Blog
                                            @endif
                                            @if ($sectionName == 'FAQ Section')
                                                FAQ
                                            @endif
                                        </a>
                                    </li>
            ...
            <li class="side-nav-item  {{ isActive('admin.application-info') }}">
                <a href="{{ route('admin.application-info') }}"><i
                        ...
                        class="badge yellow-color">2.3</span></a>
            </li>
        </ul>
    </div>
</div>
