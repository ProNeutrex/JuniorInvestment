                ...
                <div class="row justify-content-center">
                    <div class="col-xl-12">
                        <div class="title-content">
                            <h2 class="title">Principal e vídeo</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="site-card">
                        ...
                        <div class="site-card-body">
                            <form action="{{ route('admin.page.section.section.update') }}" method="post"
                                ...
                                @if($key =='en')
                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">Vídeo Code</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="video" class="box-input"
                                               value="{{$data->video}}">
                                    </div>
                                </div>
                                @endif
