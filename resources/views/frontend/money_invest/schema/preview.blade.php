                            ...
                            <div class="transaction-list table-responsive">
                                <table class="table preview-table">
                                    ...
                                    <tr>
                                        ...
                                        <td id="amount">
                                            {{ $schema->type == 'range' ? 'Minimo: ' . $schema->min_amount .' '.$currency. ' - ' . 'Máximo ' . $schema->max_amount.' '.$currency :  $schema->fixed_amount.' '.$currency }}
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="input-group mb-0">
                                                <input type="text" class="form-control"
                                                       ...
                                                       readonly @endif placeholder="Quanto quer investir?"
                                    ...
                                    <tr>
                                        <td><strong>{{ __('Retorno Aproximado:') }}</strong></td>
                                    ...
                                    <tr>
                                        ...
                                        <td id="capital_back">{{ $schema->capital_back ? 'Sim' : 'Não' }}</td>
                                    </tr>
                                    <tr>
