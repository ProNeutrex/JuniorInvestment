            ...
            <div class="site-card">
                <div class="site-card-header">
                    ...
                    <div class="card-header-links">
                        <a href="{{ route('user.withdraw.account.create') }}" class="card-header-link">{{ __('Add New') }}</a>
                    </div>
                </div>
                    ...
                    <div class="site-transactions">
                        @foreach ($accounts as $account)
                            <div class="single">
                                ...
                                <div class="right">
                                    <div class="action">
                                        <a href="{{ route('user.withdraw.account.edit', $account->id) }}"><i
                                                icon-name="edit"></i></a>
                                       <a href="{{ route('user.withdraw.account.delete', $account->id) }}"><i
                                                icon-name="trash"></i></a>
                                    </div>
                                </div>
                            </div>
