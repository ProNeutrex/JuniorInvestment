<div class="row">
    <div class="col-12">
        <div class="user-wallets-mobile">
            ...
            <div class="head">{{ __('Meu Lucro') }}</div>
            <div class="one p-wal">
                <div class="balance">
            ...
            <div class="info">
                <i icon-name="info"></i>{{ __('You Earned') }} {{ $currencySymbol }}{{ number_format($dataCount['profit_last_7_days'],2) }} {{ __('This Week') }}
            </div>
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="mob-shortcut-btn">
            <a href="{{ route('user.wallet-exchange') }}"><i icon-name="download"></i> {{ __('Transferir') }}</a>
