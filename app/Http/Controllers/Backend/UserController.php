    ...
    public function balanceUpdate($id, Request $request)
    {
        ...
        try {
            ...
            if ($type == 'add') {
                ...
                Txn::new($amount, 0, $amount, 'system', 'Valor adicionado '.ucwords($wallet).' Wpelo sistema', TxnType::Deposit, TxnStatus::Success, null, null, $id, $adminUser->id, 'Admin');
                ...
                Txn::new($amount, 0, $amount, 'system', 'Valor retirado '.ucwords($wallet).' pelo sistema', TxnType::Subtract, TxnStatus::Success, null, null, $id, $adminUser->id, 'Admin');
                $status = 'success';
