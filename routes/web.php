...
use App\Http\Controllers\Frontend\ObrigadoController;
use App\Http\Controllers\Frontend\PageController;
use App\Http\Controllers\Frontend\RedeController;
...
// Novas páginas 
Route::get('/rede', [RedeController::class, 'index'])->name('rede');
...
Route::group(['middleware' => ['auth', '2fa', 'isActive', setting('email_verification', 'permission') ? 'verified' : 'web'], 'prefix' => 'user', 'as' => 'user.'], function () {
    ...
    // transações 
    Route::get('transacoes', [DashboardController::class, 'transacoes'])->name('transacoes');

    // Coins
    Route::get('coin', [CoinController::class, 'index'])->name('coin');
    Route::post('coin/buy', [CoinController::class, 'buy'])->name('coin.buy');
    ...
    Route::group(['prefix' => 'deposit', 'as' => 'deposit.'], function () {
        ...
        Route::get('suitpay/confirmar', [DepositController::class, 'confirmar'])->name('confirmar.suitpay');
    ...
    Route::group(['middleware' => 'KYC', 'prefix' => 'withdraw', 'as' => 'withdraw.', 'controller' => WithdrawController::class], function () {
        ...
        Route::get('account/delete/{id}', 'delete')->name('account.delete');
    });
    //email check
