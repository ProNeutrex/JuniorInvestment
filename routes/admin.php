...
// =============== Coins  ====================== 
Route::group(['prefix' => 'coins', 'as' => 'coins.', 'controller' => CoinController::class], function () {
    Route::get('/index', 'index')->name('index');
    Route::get('/index/aprovar/{id}', 'aprovar')->name('index.aprovar');
    Route::post('/index/deletar/{id}', 'deletar')->name('index.deletar');
